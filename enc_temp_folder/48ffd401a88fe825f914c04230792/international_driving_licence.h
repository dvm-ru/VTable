...
public:
    ...
    {
        //typedef void (InternationalDrivingLicence::* const PrintID)() const;
        //vtable_ptr_->PrintID = reinterpret_cast<PrintID>(IdentityDocument::VTABLE.PrintID);
    ...
    operator T() {
        ...
        //driving_licence_.vtable_ptr_ = reinterpret_cast<VTable*>(&DrivingLicence::VTABLE);
        //driving_licence_.identity_.vtable_ptr_ = reinterpret_cast<VTable*>(&DrivingLicence::VTABLE);
        //driving_licence_.vtable_ptr_ = reinterpret_cast<VTable3*>(&InternationalDrivingLicence::VTABLE);
        if (driving_licence_.vtable_ptr_ == reinterpret_cast<VTable3*>(&InternationalDrivingLicence::VTABLE)) {
            driving_licence_.vtable_ptr_ = &DrivingLicence::VTABLE;
        }
        return *base_ptr;
