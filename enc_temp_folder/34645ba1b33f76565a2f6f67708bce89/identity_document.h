...
struct VTable {								            // перечислить все виртуальные функции
    ...
    //void (*PrintID_IdentityDocument)(const IdentityDocument* self);
...
public:
    ...
    void PrintID() const {
        //IdentityDocument::VTABLE.PrintID_IdentityDocument(this);
        //(this->*IdentityDocument::VTABLE.PrintID)();
...
//void PrintID_IdentityDocument(const IdentityDocument* self) {				                                // Foo::a()
//    //self->PrintID();
//    //std::cout << "IdentityDocument::PrintID() : "sv << unique_id_ << std::endl;
//}
