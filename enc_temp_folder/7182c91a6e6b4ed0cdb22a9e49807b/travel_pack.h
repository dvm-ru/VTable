...
public:
    TravelPack()
        ...
        //: identity_doc1_(new ((IdentityDocument*)Passport()) IdentityDocument())
        //, identity_doc2_(new ((IdentityDocument*)DrivingLicence()) IdentityDocument())
    ...
    TravelPack(const TravelPack& other)
        ...
        //, identity_doc1_(new IdentityDocument(*dynamic_cast<IdentityDocument*>(other.identity_doc1_)))
        //, identity_doc2_(new IdentityDocument(*dynamic_cast<IdentityDocument*>(other.identity_doc2_)))

        //, identity_doc1_(reinterpret_cast<IdentityDocument*>(new Passport(*dynamic_cast<Passport*>(other.identity_doc1_))))
        //, identity_doc2_(reinterpret_cast<IdentityDocument*>(new DrivingLicence(*dynamic_cast<DrivingLicence*>(other.identity_doc2_))))
